...
defmodule File.Only.IE do
  ...
  #
  #   IE.log_error # And then check log files
  #   IE.log_info # And then check log files
  #   IE.log_warning # And then check log files
